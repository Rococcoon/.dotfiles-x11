...
# bash
ln -sf ~/.dotfiles-x11/config/bash/bashrc ~/.bashrc
echo "Old Alacritty config removed and symlink created."


# Alacritty
ln -sf ~/.dotfiles-x11/config/alacritty ~/.config/
echo "Old Alacritty config removed and symlink created."

# i3
ln -sf ~/.dotfiles-x11/config/i3 ~/.config
